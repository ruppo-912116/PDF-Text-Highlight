...
const {
  ...
  version,
  XfaLayer,
} = globalThis.pdfjsLib; // ./web/annotation_layer_builder.js
...
class TextHighlighter {
  ...
  _updateMatches(reset = false) {
    ...
    for (const match of matches) {
      ...
      // console.log("match begin: ", match.begin.divIdx);
      // console.log("match end: ", match.end.divIdx);
      for (let n = begin, end = match.end.divIdx; n <= end; n++) {
        const div = textDivs[n];
        // console.log("div", div);
        div.textContent = textContentItemsStr[n];
        div.className = "";
        // console.log("div-final", div);
      }
